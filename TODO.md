...
- [ ] integrate texlive niceties likely from archive repo in github
- [ ] also get the brew setup from one my past projects where brew packages were immediately available after 1st login
